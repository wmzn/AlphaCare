...
import 'package:argon_flutter/screens/VisitesCom.dart';
import 'package:argon_flutter/screens/pharmacies.dart';
import 'package:argon_flutter/screens/LogingScreen.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        routes: <String, WidgetBuilder>{
          ...
          "/pharmacies": (BuildContext context) => new ElementsPharmacies(),
          "/VisiteCom": (BuildContext context) => new VisitesCom(),
